...
<div class="container">
  ...
  <div class="date_menu" class="row">
    ...
    <div id="date" class="three columns">
			...
			<a href="#" >
			<?php 
    $result = mysql_query("SELECT surname AS first FROM users WHERE id_user = '$id_user'");
	while($user = mysql_fetch_object($result))
	{echo $user->first;}
	$result = mysql_query("SELECT lastname AS second FROM users WHERE id_user = '$id_user'");
	while($user = mysql_fetch_object($result))
	{echo $user->second;}
	?>
	</a>
  ...
  <div class="day_timeline" class="row">
	...
	<div class="tags"  class="row">
		<div class="one column">
			<a class="icon" href="todo.php"><div data-icon="o" class="icon stats_size"></div></a>
		</div>
		...
		<div class="one column"><div data-icon="f" id="rightalign" class="icon stats_size"></div></div>
  </div>
  ...
  <div class="fields_text_location" class="row">
    ...
    <div class="one-third column fields">
		...
		<div style="background-color: #dddddd;" class="one-third column">
			...
			<select id="location">
			<?php
				$result = mysql_query("SELECT `id`,`name` FROM `location` WHERE user='$id_user'");
			...
			<a class="icon" href="map.php"><div data-icon="e" id="map_link" class="icon stats_size"></div></a>
		</div>
